...
pub fn fr_from_bytes_be_mod_order(bytes: &[u8]) -> pb::Fr {
...
pub fn affine_g1_msm(points: &[pb::AffineG1], scalars: &[pb::Fr]) -> pb::AffineG1 {
...
pub fn affine_g1_neg(p: pb::AffineG1) -> pb::AffineG1 {
...
pub fn affine_g1_add(a: pb::AffineG1, b: pb::AffineG1) -> Result<pb::AffineG1, PlonkError> {
...
pub fn affine_g1_sub(a: pb::AffineG1, b: pb::AffineG1) -> Result<pb::AffineG1, PlonkError> {
    pb::AffineG1::from_jacobian(pb::G1::from(a) - pb::G1::from(b))
        .ok_or(PlonkError::GeneralError(Error::InvalidPoint))
}
